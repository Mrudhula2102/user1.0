  ...
  <path d="M5.74661 13.1645C7.28678 14.2388 9.78389 14.2388 11.3241 13.1645C12.8642 12.0902 12.8642 10.3484 11.3241 9.27415C9.78389
   ...
   30.7871 15.1716 30.7871 13.2464 32.1299C11.3212 33.4728 11.3212 35.65 13.2464 36.9929Z" class="ccustom" fill="#25CAAC"></path>
    ...
    <ul id='navbar' className={clicked ? "active" : "" }>
         ...
         <li><a href='/home' className={activeLink === '/home' ? 'active' : ''} onClick={() => handleClick('/home')}  
         style={fontSizeStyle}><HomeIcon fontSize='small'/> Home</a></li>

          <li> <a href='/Myprofile' className={activeLink === '/Myprofile' ? 'active' : ''} onClick={() => handleClick('/Myprofile')} 
          style={fontSizeStyle}><AccountCircleIcon fontSize='small'/> My Profile</a></li>

            <li><a href='/Employeedetails' className={activeLink === '/Employeedetails' ? 'active' : ''} onClick={() => handleClick('/Employeedetails')}
            style={fontSizeStyle}><BadgeIcon fontSize='small'/> Employee Details</a></li>
